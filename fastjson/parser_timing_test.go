...
var (
	...
	smallFixture  = getFromFile("testdata/small.fastjson")
	mediumFixture = getFromFile("testdata/medium.fastjson")
	largeFixture  = getFromFile("testdata/large.fastjson")
	...
	canadaFixture  = getFromFile("testdata/canada.fastjson")
	citmFixture    = getFromFile("testdata/citm_catalog.fastjson")
	twitterFixture = getFromFile("testdata/twitter.fastjson")
)
