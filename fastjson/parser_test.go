...
func TestParseRawString(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		f := func(s, expectedRS, expectedTail string) {
			...
			rs, tail, err = parseRawKey(s[1:], false)
			if err != nil {
	...
	t.Run("error", func(t *testing.T) {
		f := func(s, expectedTail string) {
			...
			// parseRawKey results must be identical to parseRawString.
			_, tail, err = parseRawKey(s[1:], false)
			if err == nil {
...
func TestT2(t *testing.T) {
	...
	v, err := p.Parse(`[{day:"2019-04-11",open:"3241.547",high:"3254.126",low:"3185.546",close:"3189.962",volume:"35303187900",ma_price5:3232.587,ma_volume5:41419447120,ma_price10:3181.212,ma_volume10:40779040810,ma_price30:3089.348,ma_volume30:41522822373}]`)
	if err != nil {
		t.Errorf("%+v\n", err)
	}
